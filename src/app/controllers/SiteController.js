        ...
        Tshirt.find({})
            .then(tshirt =>{
                let tshirts = tshirt.filter(function(product){
                    if(product.name.includes(search)){ var name = product.name; return product.name === name};
                    if(product.color.includes(search)){ var color = product.color; return product.color === color}; 
                    if(product.product.includes(search)){ var type = product.product; return product.product === type}; 
                });               
