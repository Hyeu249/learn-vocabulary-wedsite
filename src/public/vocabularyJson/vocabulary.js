...
const json = [
  ...
  "deliberate (adj,v): chủ đích, cân nhắc<br>+ deliberation (n): sự cân nhắc",
  "induce (v): gây ra",
  "punctual (adj): đúng giờ",
  "assess (n): đánh giá, thẩm định",
  "comply (v): tuân thủ<br>+ compliant (adj): tuân thủ<br>+ compliance (n): tuân thủ.",
  ...
  "segment (n): đoạn, bộ phận, phân khúc",
  "strive (v): cố gắng",
  "mandate (n): bắt buộc, ủy thác, nhiệm vụ",
  ...
  "pension (n): lương hưu",
  "peer (n): ngang hàng, xem xét, đồng nghiệp",
